...
Commit your work to the current branch. If that branch is the trunk (`master`, `GIT_TRUNK` in `.claude/project.env`), create a branch with `scripts/worktree-create.sh <name>` and commit there instead.
