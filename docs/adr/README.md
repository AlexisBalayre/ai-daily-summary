...
never reused. None recorded yet; the first real decision is `0001`. Earlier decisions live as dated
design notes in [`docs/design/`](../design/); don't rewrite them, supersede them with an ADR.
